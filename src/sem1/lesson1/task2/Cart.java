...
//        boolean carbohydrates = false;
        ...
        for (var thing : market.getThings(clazz)) {
            if (foodstuffs.stream()
                    .noneMatch(Food::getProteins)) foodstuffs.add(thing);
            if (foodstuffs.stream()
                    .noneMatch(Food::getFats)) foodstuffs.add(thing);
            if (foodstuffs.stream()
                    .noneMatch(Food::getCarbohydrates)) foodstuffs.add(thing);
        }
